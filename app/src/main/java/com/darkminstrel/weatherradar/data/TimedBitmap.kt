...
class TimedBitmap(val ts:Long, val bitmap: Bitmap, val radar: String) {

    companion object {
        @WorkerThread
        fun create(ts:Long, rawBitmap: Bitmap, radar: String):TimedBitmap{
            ...
            return TimedBitmap(ts, bitmap, radar)
        }
